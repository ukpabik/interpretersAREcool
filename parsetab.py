...
_lr_action_items = {'ID':([0,1,2,5,6,7,10,13,14,15,16,17,18,19,28,29,30,31,32,],[3,3,-2,-1,8,8,8,-3,8,8,8,8,8,8,3,3,-15,-13,-14,]),'IF':([0,1,2,5,13,28,29,30,31,32,],[4,4,-2,-1,-3,4,4,-15,-13,-14,]),'$end':([1,2,5,13,31,],[0,-2,-1,-3,-13,]),'ASSIGN':([3,],[6,]),'LPAREN':([4,],[7,]),'MINUS':([6,7,8,9,10,11,12,14,15,16,17,18,19,20,22,23,24,25,26,27,],[10,10,-12,15,10,-11,15,10,10,10,10,10,10,-10,-4,-5,-6,-7,15,15,]),'NUMBER':([6,7,10,14,15,16,17,18,19,],[11,11,11,11,11,11,11,11,11,]),'SEMICOLON':([8,9,11,20,22,23,24,25,26,27,],[-12,13,-11,-10,-4,-5,-6,-7,-8,-9,]),'PLUS':([8,9,11,12,20,22,23,24,25,26,27,],[-12,14,-11,14,-10,-4,-5,-6,-7,14,14,]),'TIMES':([8,9,11,12,20,22,23,24,25,26,27,],[-12,16,-11,16,-10,16,16,-6,-7,16,16,]),'DIVIDE':([8,9,11,12,20,22,23,24,25,26,27,],[-12,17,-11,17,-10,17,17,-6,-7,17,17,]),'GREATERTHAN':([8,9,11,12,20,22,23,24,25,26,27,],[-12,18,-11,18,-10,-4,-5,-6,-7,18,18,]),'LESSTHAN':([8,9,11,12,20,22,23,24,25,26,27,],[-12,19,-11,19,-10,-4,-5,-6,-7,19,19,]),'RPAREN':([8,11,12,20,22,23,24,25,26,27,],[-12,-11,21,-10,-4,-5,-6,-7,-8,-9,]),'RBRACE':([13,29,30,31,32,],[-3,31,-15,-13,-14,]),'LBRACE':([21,],[28,]),}
...
_lr_goto_items = {'program':([0,],[1,]),'statement':([0,1,28,29,],[2,5,30,32,]),'expression':([6,7,10,14,15,16,17,18,19,],[9,12,20,22,23,24,25,26,27,]),'statements':([28,],[29,]),}
